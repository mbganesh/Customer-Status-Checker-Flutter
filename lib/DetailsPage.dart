                                  ...
                                  child: Container(
                                    ...
                                    child: Card(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Center(
                                          child: Text(
                                            getDateFormat(jsonObj["message"][0]
                                                    ["orderDate"]
                                                .toString()),
                                            style: TextStyle(
                                              fontWeight: FontWeight.bold,
                                    ...
                                    SizedBox(
                                        ...
                                        child: Column(
                                          children: [
                                            ...
                                            Image.memory(
                                              getImageView(jsonObj["message"][0]
                                                          ["salwarData"][index]
                                                      ["dressImage"]
                                                  .toString()),
                                            ),
...
// don`t touch right now!!!
                    ...
                    ListView.builder(
                        ...
                        physics: const ClampingScrollPhysics(),
                        itemCount: int.parse(
                            jsonObj["message"][0]["blouseCount"].toString()),
                        itemBuilder: (context, index) {
